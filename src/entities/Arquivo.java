...
public class Arquivo {
	...
	public static void sortear() {
        ...
        for (boolean assistido : assistidos) {
            if (!assistido) {
        ...
        if (!todosAssistidos) {
            ...
            do {
                proximoFilme = random.nextInt(100);
            } while (assistidos[proximoFilme]);
            
            System.out.println("O próximo filme a ser assistido é: " + (proximoFilme + 1));
        } else {
